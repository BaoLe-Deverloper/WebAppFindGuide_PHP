...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="css/plugins/jquery.timepicker.css">
      ...
      <div class="container">
        ...
        <nav role="navigation" class="probootstrap-nav hidden-xs">
          <ul class="animated fadeInLeft probootstrap-main-nav">
            ...
            <img src="img/'.$_SESSION['avata'].'" class="img-circle avatar_user" alt="user name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
